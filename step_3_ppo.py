...
class ScriptArguments:
    ...
    ref_model_name: Optional[str] = field(default="output/rm_2/checkpoint-50000", metadata={"help": "the model name"})
...
sentiment_pipe = pipeline("sentiment-analysis", model=script_args.ref_model_name, device=device)
